...
(function () {
  ...
  var WRESTLERS = (window.FAW_DATA && window.FAW_DATA.roster) ? window.FAW_DATA.roster : [
    ...
    { name: 'Mustang Mike', initials: 'MM', role: 'High Flyer', tags: ['flyer'], color: '#ff2e4c', glow: 'rgba(255,46,76,0.3)', img: 'img/mustang-mike.webp', height: '5\'9"', weight: '175 lbs', from: 'Dallas, TX', bio: 'Built like a muscle car and twice as fast. The crowd-favorite underdog with a motor that never quits.', signature: 'The Stampede' },
